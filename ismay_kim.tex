...
\NormalTok{needed_pkgs <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"nycflights13"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }
  \StringTok{"devtools"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"dygraphs"}\NormalTok{, }\StringTok{"rmarkdown"}\NormalTok{)}
...
\begin{verbatim}
## [1] "By cismay on Tuesday, August 23, 2016 15:50:07 PDT"
\end{verbatim}
...
\part{Inference}\label{part-inference-1}
...
\section{Topics to be Dropped}\label{topics-to-be-dropped-1}
