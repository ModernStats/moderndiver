...
for ``RStudio'' and in Appendix A - Chapter \ref{appendix1}.
...
\NormalTok{needed_pkgs <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"nycflights13"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }
  \StringTok{"devtools"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"webshot"}\NormalTok{, }\StringTok{"dygraphs"}\NormalTok{, }\StringTok{"tufte"}\NormalTok{)}
...
\begin{verbatim}
## [1] "By Chester on Thursday, August 18, 2016 15:32:06 PDT"
\end{verbatim}

\section{Colophon}\label{colophon}

The source of the book is available at \textbf{UPDATE THIS} and was
built with versions of R packages given here. This may not be of
importance for initial readers of this book, but you can reproduce a
...
\hline
rmarkdown &  & 1.0.9002 & 2016-08-17 & Github (rstudio/rmarkdown@2674682)\\
\hline
...
\hline
tufte &  & 0.2 & 2016-02-07 & CRAN (R 3.3.0)\\
\hline
...
\begin{itemize}
\item
  ``The most important tool is the \emph{mindset}, when starting, that
  the end product will be reproducible.'' -- Keith Baggerly
\item
...
\textbf{Include discussion on ethics of various datasets}.

\textbf{Need to give big picture question here and set up how this
chapter ties in to chapters to come}.

\textbf{Force dataframes into tibbles using \texttt{as\_tibble} or
\texttt{tbl\_df}? That way \texttt{head} isn't needed since printing
will be nice by default. \url{http://r4ds.had.co.nz/tibbles.html}}
...
called (We will see in Chapter \ref{manip} ways to change \texttt{name}
...
\textbf{Most important thing with graphics is making it obvious for your
audience to see the findings you want to get across}

\textbf{To create insights into the data}
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-12-1} 

}

\caption[Strip Plot of Hourly Temperature Recordings from NYC in 2013]{Strip Plot of Hourly Temperature Recordings from NYC in 2013}\label{fig:unnamed-chunk-12}
\end{figure}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\caption[Histogram of Hourly Temperature Recordings from NYC in 2013]{Histogram of Hourly Temperature Recordings from NYC in 2013}\label{fig:unnamed-chunk-14}
\end{figure}
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-15-1} 

}

\caption[Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Bins]{Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Bins}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption[Histogram of Hourly Temperature Recordings from NYC in 2013 - Binwidth = 10]{Histogram of Hourly Temperature Recordings from NYC in 2013 - Binwidth = 10}\label{fig:unnamed-chunk-16}
\end{figure}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-18-1} \end{center}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-21-1} 

}

\caption[Number of flights departing NYC in 2013 by airline]{Number of flights departing NYC in 2013 by airline}\label{fig:unnamed-chunk-21}
\end{figure}
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-27-1} 
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-28-1} 
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-29-1} 
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-31-1} \end{center}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-32-1} \end{center}
...
\begin{center}\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
Link to \url{http://ismayc.github.io/rbasics-book} or reproduce the
documents here?
...
{\centering \includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-38-1} 

}

\caption[Number of flights departing NYC in 2013 by airline - Descending numbers]{Number of flights departing NYC in 2013 by airline - Descending numbers}\label{fig:unnamed-chunk-38}
\end{figure}
...
\chapter{Appendix C: R Markdown}\label{appendix3}
